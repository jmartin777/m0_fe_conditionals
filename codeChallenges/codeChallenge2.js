//Medium: Using the following variables:
...
// the user either has a good record or is over 25 years old, 
// they should pay full price .If the user is not over 25 and has a bad 
// driving record, they need to have someone else sign for the rental
...
if (goodDrivingRecord === true && age > 25) {
  ...
  console.log("Someone else needs to sign for this rental");
  } 
